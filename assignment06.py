...
#
#   1. Create a new branch in PyCharm with name assignment06
...
#   4. Go to github.com and create a 'Pull Request' for the 'assignment06' branch, and assign it to 'mtday'
#
